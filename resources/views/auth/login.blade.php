            ...
            <div class="w-full px-4 lg:px-8 xl:px-20">
                <div class="flex flex-col justify-center align-center text-center">
                    ...
                    <div class="flex flex-wrap justify-center items-center w-full pt-10">
                        <p class="text-p text-xs w-full py-1"><a href="{{ route('register') }}">Nemate nalog? <span class="text-queen-blue hover:text-fiery-red"> Registrujte se.</span></a></p>
